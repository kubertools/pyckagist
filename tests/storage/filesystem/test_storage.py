...
class TestFilePackageStorage:
    def test_resolve_package_path_for_different_platforms(self, mocker):
        ...
        expected_path_windows = "/fake/path/testpkg-1.0.0-windows-x86_64.exe"
        expected_path_linux = "/fake/path/testpkg-1.0.0-linux-x86_64"
    ...
    def test_delete_package(self, mocker):
        ...
        exists_mock.assert_called_once_with("/fake/path/testpkg-1.0.0-system-arch")
        remove_mock.assert_called_once_with("/fake/path/testpkg-1.0.0-system-arch")
